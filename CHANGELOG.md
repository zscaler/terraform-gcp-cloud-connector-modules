...
FEATURES:
* Official support for Cloud Connector Auto Scaling on GCP - (Requires new Marketplace Compute Image: zs-cc-ga-01232026 or greater )
...
ENHANCEMENTS:
* add: variable marketplace_image for all deployment templates defaulting to the latest available image "zs-cc-ga-01232026" upgraded to ZscalerOS 42 and supporting autoscaling
