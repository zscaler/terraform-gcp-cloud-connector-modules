...
## 28. Provide the domain names you want Google Cloud DNS to redirect to Cloud Connector for ZPA interception.
...
#####                                 E.g. "cc_asg"                                               #####
#####################################################################################################################
## 29. By default, this script will create two new GCP VPC Networks (CC Management and CC Service).
##     Uncomment if you want to deploy all resources to VPCs that already exists (true or false. Default: false)

#byo_vpc                                    = true

## 30. Provide your existing VPC Network friendly names. Only uncomment and modify if you set byo_vpc to true. (Default: null)

##byo_mgmt_vpc_name                         = "cc-mgmt-vpc-123"
##byo_service_vpc_name                      = "cc-service-vpc-123"

## 31. By default, this script will create a new subnet in both the mgmt and service VPC networks.
...
## 32. Provide your existing Cloud Connector subnet friendly names. Only uncomment and modify if you set byo_subnets to true.
##
...
## 33. By default, this script will create new Cloud Routers in both the mgmt and service VPC networks.
...
## 34. Provider your existing Cloud Router friendly names. Only uncomment and modify if you set byo_router to true.
##
...
## 35. By default, this script will create new Cloud NAT Gateways associated with VPC Cloud Routers in
...
## 36. Provide your existing Cloud NAT Gateway friendly names. Only uncomment and modify if you set byo_natgw to true.
