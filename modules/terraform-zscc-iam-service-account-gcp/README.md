...
| Name | Type |
|------|------|
| [google_project_iam_custom_role.autoscaler_role](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/project_iam_custom_role) | resource |
...
| [google_project_iam_member.mig_viewer](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/project_iam_member) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_autoscaler_role_id"></a> [autoscaler\_role\_id](#input\_autoscaler\_role\_id) | ID for the autoscaler custom role | `string` | `"migAutoscalerViewer"` | no |
